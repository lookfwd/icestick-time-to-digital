...
Use the "Diamond Programmer" as described in "Programming Demo Designs with Lattice Programmer" section of the iCEstick Evaluation Kit User's Guide. The `.bin` file will be inside the `build` directory.
