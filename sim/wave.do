...
add wave -noupdate /top_tb/tdc_inst/uart_busy_d
add wave -noupdate /top_tb/tdc_inst/uart_done
...
WaveRestoreCursors {{Cursor 1} {1500172900 ps} 0}
...
update
WaveRestoreZoom {1497593200 ps} {1508772 ns}
